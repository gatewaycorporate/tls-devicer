 ...
 */
export function extractHeaderSignals(
  headers: Record<string, string | string[] | undefined>,
): Pick<TlsProfile, 'headerOrder' | 'headerValues'> {
 ...
 */
export function headerOrderSimilarity(a: string[], b: string[]): number {
 ...
 */
export function headerValueSimilarity(
